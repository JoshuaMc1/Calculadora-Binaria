...
import { isBinary, binaryToOctal } from "../helpers/helper";
...
const Octal = () => {
  ...
  /**
   * The handleSubmit function takes an event as input, prevents the default behavior, checks if the
   * binary input is valid, converts it to octal, and sets the result accordingly.
  ...
  const handleSubmit = (event) => {
    ...
    const octalValue = binaryToOctal(binaryInput);

    setResult(`Resultado: ${octalValue}`);
  };
